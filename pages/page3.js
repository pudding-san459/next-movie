          ...
          <p className="text-4864 text-white text-wrap whitespace-normal w-600 font-semibold font-dm font-sans">Search your movies here!</p>
            <form>
                <div className="relative mt-4">
                  ...
                  <input type="search" id="search" className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 rounded-full" placeholder="Theatre name..." required />
                </div>
                <div className="flex">
                  <div className="relative mt-6">
                    ...
                    <input type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-301 h-54 ps-10 p-2.5" placeholder="23/12/2021 - 10.00 AM" />
                  </div>
